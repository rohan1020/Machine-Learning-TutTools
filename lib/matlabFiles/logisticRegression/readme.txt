...
================================
-run_sigout.sh (shell script run to temporarily set environment variables and execute the 
 application)
   -to run the shell script, type
   
       ./run_sigout.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v717, run the shell script as:
       ...
       ./run_sigout.sh /mathworks/home/application/v717
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_sigout.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -include when building component by clicking "Add MCR" link 
    in deploytool
-The Macintosh bundle directory structure sigout.app 
   -this can be gathered up using the zip command 
    zip -r sigout.zip sigout.app
    or the tar command 
    tar -cvf sigout.tar sigout.app
-This readme file 
...
A. Mac systems:
   ...
   Compiler User's Guide.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_sigout.sh 
